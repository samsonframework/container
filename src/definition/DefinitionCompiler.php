...
class DefinitionCompiler
{
     ...
     */
    public function compile(array $classDefinitionCollection)
    {
        $methodGenerator = $this->generator
            ->defNamespace((new \ReflectionClass(self::class))->getNamespaceName())
                ->defMethod('logic')
        ...
        $code = '<?php ' . $this->generator->code();
        print($code);
        file_put_contents(__DIR__ . '/../../tests/definition/Container.php', $code);
    }
